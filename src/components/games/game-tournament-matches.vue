    ...
    <div class="game-tournament-matches">
        <div v-if="videos.length > 0">
            ...
            <div v-if="isLast" class="feed-end">
                ...
                <p class="feed-end-subtitle">No more tournament matches for this game. Try filtering by a specific character or head back home.</p>
            ...
            response.data.matches.forEach((video) => {
                this.videos.push({
                    ...
                    game: {
                        ...
                        abbreviation:
                            video.Game && video.Game[0] && video.Game[0].Abbreviation
                                ? video.Game[0].Abbreviation
                                : null,
                    },
                    match: {
