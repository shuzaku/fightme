...
const routes = [
    ...
    {
        path: '/game/:gameKey/character/:characterKey/montages',
        name: 'Game Character Montages Tab',
        component: Character,
    },
    {
    ...
    { path: '/character/:id/montages', name: 'Character Montages Tab', component: Character },
    ...
    { path: '/c/:slug/montages', name: 'Character Slug Montages Tab', component: Character },
